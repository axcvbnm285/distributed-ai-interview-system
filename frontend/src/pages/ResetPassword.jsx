...
function ResetPassword() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f13] grid-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-80px] right-[-80px] w-[320px] h-[320px] bg-emerald-600/10 rounded-full blur-[80px] pointer-events-none" />

      <div className="w-full max-w-md animate-fade-in-up">
        <div className="glass rounded-2xl p-8 shadow-2xl">
          <h1 className="text-2xl font-semibold text-white mb-1">Reset Password</h1>
          <p className="text-sm text-gray-500 mb-7">Choose a new strong password for your account.</p>
